...
func homeHandler(w http.ResponseWriter, r *http.Request) {
	fmt.Fprint(w, "Run http://host:8080/test-cpu or http://host:8080/healthz\n")
}
...
// healthzHandler provides a simple, non-intensive health check endpoint.
