...
// Options for the stress test. We define stages that simulate a stready increase in
// traffic to reach maximum capacity.
export let options = {
  ...
  stages: [
    ...
    { duration: '1m', target: 100 }, // Stage 2: Slowly ramp up to 100 VUs in 1 minute.
    { duration: '2m', target: 1000 },  // Stage 3: Ramp up to a 1000 VUs in 2 minutes.
    { duration: '1m', target: 1000 },  // Stage 4: Hold the top end for 1 minutes.
...
export default function () {
  ...
  const res = http.get('http://localhost.default.svc.cluster.local:8080/test-cpu');
